...
def searching_db(request):
    ...
    return redirect('summary:summary',searched_code)

def summary(request,searched_code):
    """
    ...
    comment_info=senti_info.values()[temp-2]['comment'] # limit 1 주고, max pk 아니면, get으로  받아도됨.
    ...
    data={'code':searched_code,'comment_value':comment_value,'a_opinion':a_opinion}
